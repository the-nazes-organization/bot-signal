...
class Command:
    ...
    def handle_attachements(self, data: DataFormated) -> None:
        """
        This function takes the data formated and call
    ...
    def handle_typing(self, data: DataFormated) -> None:
        """
        This function takes the data formated and call
    ...
    def handle_message(self, data: DataFormated) -> None:
        """
        This function takes the data formated and call
    ...
    @staticmethod
    def is_condition_true(condition, data: DataFormated):
        """
